...
internal partial class TestStrategy : global::Jameak.CursorPagination.Abstractions.KeySetPagination.IKeySetPaginationStrategy<global::TestNamespace.TestInput<int>, TestStrategy.Cursor>, global::Jameak.CursorPagination.Abstractions.KeySetPagination.IKeySetCursorSerializer<TestStrategy.Cursor>
{
    /// <inheritdoc />
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Jameak.CursorPagination.SourceGenerator", "LOCALBUILD")]
    public global::System.Linq.IQueryable<global::TestNamespace.TestInput<int>>
        ApplyPagination(
        global::System.Linq.IQueryable<global::TestNamespace.TestInput<int>> queryable,
        int pageSize,
    ...
    /// <inheritdoc />
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Jameak.CursorPagination.SourceGenerator", "LOCALBUILD")]
    public (global::System.Func<global::System.Linq.IQueryable<global::TestNamespace.TestInput<int>>, global::System.Linq.IQueryable<global::TestNamespace.TestInput<int>>> applyWhereExpr,
            global::System.Func<global::System.Linq.IQueryable<global::TestNamespace.TestInput<int>>, global::System.Linq.IOrderedQueryable<global::TestNamespace.TestInput<int>>> applyOrderExpr,
            global::System.Func<global::System.Linq.IQueryable<global::TestNamespace.TestInput<int>>, global::System.Linq.IQueryable<global::TestNamespace.TestInput<int>>> applyTake)
        ...
        Cursor? afterCursor)
    {
        ...
        global::System.Func<global::System.Linq.IQueryable<global::TestNamespace.TestInput<int>>, global::System.Linq.IQueryable<global::TestNamespace.TestInput<int>>> whereFunc;
        if(whereExpr != null)
        {
        ...
        global::System.Func<global::System.Linq.IQueryable<global::TestNamespace.TestInput<int>>, global::System.Linq.IOrderedQueryable<global::TestNamespace.TestInput<int>>> orderFunc =
        ...
        global::System.Func<global::System.Linq.IQueryable<global::TestNamespace.TestInput<int>>, global::System.Linq.IQueryable<global::TestNamespace.TestInput<int>>> takeFunc =
    ...
    public void PostProcessMaterializedResultInPlace(
        global::System.Collections.Generic.List<global::TestNamespace.TestInput<int>> materializedResult,
        int pageSize,
        bool checkHasNextPage,
        global::Jameak.CursorPagination.Abstractions.Enums.PaginationDirection paginationDirection,
    ...
    /// <inheritdoc />
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Jameak.CursorPagination.SourceGenerator", "LOCALBUILD")]
    public Cursor CreateCursor(global::TestNamespace.TestInput<int> data)
    {
        if (data == null)
        {
...
file class PrivateHelper
{
    ...
    internal static global::System.Linq.IOrderedQueryable<global::TestNamespace.TestInput<int>> ApplyOrderBy(
        global::System.Linq.IQueryable<global::TestNamespace.TestInput<int>> queryable,
        global::Jameak.CursorPagination.Abstractions.Enums.PaginationDirection paginationDirection)
    {
        switch (paginationDirection)
        {
            case global::Jameak.CursorPagination.Abstractions.Enums.PaginationDirection.Forward:
                {
                    var orderedQueryable = global::System.Linq.Queryable.OrderBy(queryable, (obj => obj.Prop));
                    return orderedQueryable;
                }
            case global::Jameak.CursorPagination.Abstractions.Enums.PaginationDirection.Backward:
                {
                    var orderedQueryable = global::System.Linq.Queryable.OrderByDescending(queryable, (obj => obj.Prop));
                    return orderedQueryable;
                }
            default:
    ...
    internal static global::System.Linq.Expressions.Expression<global::System.Func<global::TestNamespace.TestInput<int>, bool>>? GetWhereExpr(
...
file class CursorHiddenNamePolicy : global::System.Text.Json.JsonNamingPolicy
{
    public override string ConvertName(string name)
    {
        return name switch
        {
            nameof(TestStrategy.Cursor.Prop) => "0",
