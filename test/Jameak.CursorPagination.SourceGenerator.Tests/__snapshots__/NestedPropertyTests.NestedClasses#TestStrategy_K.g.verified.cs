...
internal partial class TestStrategy : global::Jameak.CursorPagination.Abstractions.KeySetPagination.IKeySetPaginationStrategy<global::TestNamespace.Level1.Level2, TestStrategy.Cursor>, global::Jameak.CursorPagination.Abstractions.KeySetPagination.IKeySetCursorSerializer<TestStrategy.Cursor>
{
    /// <inheritdoc />
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Jameak.CursorPagination.SourceGenerator", "LOCALBUILD")]
    public global::System.Linq.IQueryable<global::TestNamespace.Level1.Level2>
        ApplyPagination(
        global::System.Linq.IQueryable<global::TestNamespace.Level1.Level2> queryable,
        int pageSize,
    ...
    /// <inheritdoc />
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Jameak.CursorPagination.SourceGenerator", "LOCALBUILD")]
    public (global::System.Func<global::System.Linq.IQueryable<global::TestNamespace.Level1.Level2>, global::System.Linq.IQueryable<global::TestNamespace.Level1.Level2>> applyWhereExpr,
            global::System.Func<global::System.Linq.IQueryable<global::TestNamespace.Level1.Level2>, global::System.Linq.IOrderedQueryable<global::TestNamespace.Level1.Level2>> applyOrderExpr,
            global::System.Func<global::System.Linq.IQueryable<global::TestNamespace.Level1.Level2>, global::System.Linq.IQueryable<global::TestNamespace.Level1.Level2>> applyTake)
        ...
        Cursor? afterCursor)
    {
        ...
        global::System.Func<global::System.Linq.IQueryable<global::TestNamespace.Level1.Level2>, global::System.Linq.IQueryable<global::TestNamespace.Level1.Level2>> whereFunc;
        if(whereExpr != null)
        {
        ...
        global::System.Func<global::System.Linq.IQueryable<global::TestNamespace.Level1.Level2>, global::System.Linq.IOrderedQueryable<global::TestNamespace.Level1.Level2>> orderFunc =
        ...
        global::System.Func<global::System.Linq.IQueryable<global::TestNamespace.Level1.Level2>, global::System.Linq.IQueryable<global::TestNamespace.Level1.Level2>> takeFunc =
    ...
    public void PostProcessMaterializedResultInPlace(
        global::System.Collections.Generic.List<global::TestNamespace.Level1.Level2> materializedResult,
        int pageSize,
        bool checkHasNextPage,
        global::Jameak.CursorPagination.Abstractions.Enums.PaginationDirection paginationDirection,
    ...
    /// <inheritdoc />
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Jameak.CursorPagination.SourceGenerator", "LOCALBUILD")]
    public Cursor CreateCursor(global::TestNamespace.Level1.Level2 data)
    {
        if (data == null)
        {
        ...
        return new Cursor(data.Nested.Data1, data.Nested.Data2);
    }
...
#region IKeySetCursorSerializer implementation
    ...
    {
        public string Nested_Data1 { get; init; }
        public string Nested_Data2 { get; init; }

        public Cursor(string Nested_Data1, string Nested_Data2)
        {
            this.Nested_Data1 = Nested_Data1;
            this.Nested_Data2 = Nested_Data2;
        }
    }
}
...
file class PrivateHelper
{
    ...
    internal static global::System.Linq.IOrderedQueryable<global::TestNamespace.Level1.Level2> ApplyOrderBy(
        global::System.Linq.IQueryable<global::TestNamespace.Level1.Level2> queryable,
        global::Jameak.CursorPagination.Abstractions.Enums.PaginationDirection paginationDirection)
    {
        switch (paginationDirection)
        {
            case global::Jameak.CursorPagination.Abstractions.Enums.PaginationDirection.Forward:
                {
                    var orderedQueryable = global::System.Linq.Queryable.OrderBy(queryable, (obj => obj.Nested.Data1));
                    orderedQueryable = global::System.Linq.Queryable.ThenBy(orderedQueryable, (obj => obj.Nested.Data2));
                    return orderedQueryable;
                }
            case global::Jameak.CursorPagination.Abstractions.Enums.PaginationDirection.Backward:
                {
                    var orderedQueryable = global::System.Linq.Queryable.OrderByDescending(queryable, (obj => obj.Nested.Data1));
                    orderedQueryable = global::System.Linq.Queryable.ThenByDescending(orderedQueryable, (obj => obj.Nested.Data2));
                    return orderedQueryable;
                }
            default:
    ...
    internal static global::System.Linq.Expressions.Expression<global::System.Func<global::TestNamespace.Level1.Level2, bool>>? GetWhereExpr(
        ...
        global::Jameak.CursorPagination.Abstractions.Enums.PaginationDirection paginationDirection)
    {
        ...
        var Nested_Data1Value = cursor.Nested_Data1;
        var Nested_Data2Value = cursor.Nested_Data2;

        switch (paginationDirection)
        {
            case global::Jameak.CursorPagination.Abstractions.Enums.PaginationDirection.Forward:
                return obj =>
                    obj.Nested.Data1!.CompareTo(Nested_Data1Value!) >= 0
                    && (
                        (obj.Nested.Data1!.CompareTo(Nested_Data1Value!) > 0) ||
                        (obj.Nested.Data1!.CompareTo(Nested_Data1Value!) == 0 && obj.Nested.Data2!.CompareTo(Nested_Data2Value!) > 0)
                    );
            case global::Jameak.CursorPagination.Abstractions.Enums.PaginationDirection.Backward:
                return obj =>
                    obj.Nested.Data1!.CompareTo(Nested_Data1Value!) <= 0
...
file class CursorHiddenNamePolicy : global::System.Text.Json.JsonNamingPolicy
{
    public override string ConvertName(string name)
    {
        return name switch
        {
            nameof(TestStrategy.Cursor.Nested_Data1) => "0",
            nameof(TestStrategy.Cursor.Nested_Data2) => "1",
